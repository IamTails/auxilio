...
class User:
    __slots__ = (
        ...
        'messages', 'jail', 'last_daily_claim', 'daily_streak', 'inventory', 'idiot', 'equipped_items', 'equipped_pets',
        'equipped_title', 'stats', 'active')
    ...
    async def claim_daily(self):
        ...
        days_since_last_claim = (
                    now.replace(tzinfo=timezone.utc) - self.last_daily_claim.replace(tzinfo=timezone.utc)).days
